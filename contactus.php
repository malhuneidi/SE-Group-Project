...
<body>
		...
		<div class="w3-padding-62">
			<div class="w3-btn-bar w3-border w3-show-inline-block w3-left">
				...
				<a href="order.php" class="w3-btn w3-border w3-xlarge w3-opacity ">Order
					...
					class="w3-btn w3-border w3-xlarge w3-opacity ">Contact Us</a> <a
					href="admin.php" class="w3-btn w3-border w3-xlarge w3-opacity ">Admin
	...
	<header class="w3-panel w3-padding-228 w3-center w3-opacity">
		...
		<h1 class="w3-large">
			<strong> 402-555-5555 <strong>
		</h1>
		<h3>Suggestions, inquiries, complaints, please fill the
			information bellow and we'll get back to you!</h3>
	</header>
	<form method="post" action="./results.php" class="w2-center">
		<h3>Your Full Name:</h3>
		<input type="text" name="title" /> <br>
		<h3>Comment:</h3>
		<textarea placeholder="Type review here..." name="review" id="review1"
			style="width: 350px; height: 75px;"> </textarea>
		<br>
		<h3>Your Email:</h3>
		<input type="text" name="link" /> <br>
		<h3>Your Phone Number:</h3>
		<input type="text" name="link" /> <br> <br> <input
			type="submit" value="Submit" name="passedData"
			class="w3-btn w3-border w3-xlarge w3-opacity w3-panel" />
	</form>
	<br>
	<br>
	<br>
