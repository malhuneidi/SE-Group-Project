	...
	if($count > 0){
		...
		*/
		...
		// Modified to hopefully go to our site
        		echo   '
				<input type="hidden" name="return" value="http://ec2-52-32-128-152.us-west-2.compute.amazonaws.com/finalVersion/payment_success.php"/>
				<input type="hidden" name="cancel_return" value="http://ec2-52-32-128-152.us-west-2.compute.amazonaws.com/finalVersion/cancel.php"/>
				<input type="hidden" name="currency_code" value="USD"/>
				<input type="hidden" name="custom" value="'.$uid.'"/>
				<input style="float:right;margin-right:80px;" type="image" name="submit"
