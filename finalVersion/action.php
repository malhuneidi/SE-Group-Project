	...
	if(isset($_POST["addToProduct"])){
		...
		if($count > 0){
			...
			echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Thai Kitchen online delivery services are exclusive to registered customers only, please sign up/sign in.</b>
					</div>
				";
		}
	...
	if($count > 0){
		...
		echo '
				...
				<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				  ...
				  <input type="hidden" name="business" value="shoppingcart@thaikitchen.com">
		...
		*/
		...
		// Modified to hopefully go to our site
        		echo   '
				<input type="hidden" name="return" value="http://ec2-52-32-128-152.us-west-2.compute.amazonaws.com/payment_success.php"/>
				<input type="hidden" name="cancel_return" value="http://ec2-52-32-128-152.us-west-2.compute.amazonaws.com/cancel.php"/>
				<input type="hidden" name="currency_code" value="USD"/>
				<input type="hidden" name="custom" value="'.$uid.'"/>
				<input style="float:right;margin-right:80px;" type="image" name="submit"
					src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/checkout-logo-medium.png"  alt="PayPal Checkout"
					alt="PayPal - The safer, easier way to pay online">
				</form>';
