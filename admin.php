...
<body>
	...
	<div class="w3-btn-bar  w3-center">
		...
		<form id="login" name="login" method="post" action="auth.php">
			<label class="w3-padding-44 w3-xlarge"> Username: </label><br>
			<input type="text" name="username" /> <br> <label
				class="w3-padding-44  w3-xlarge"> Password: </label><br>
			<input type="password" name="password" /> <br> <input
				type="submit" value="Login" name="signin" class="w3-xlarge w3-panel" />
